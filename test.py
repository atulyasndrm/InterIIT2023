...
class pidcontroller:
    ...
    def __init__(self, IP, PORT, targ, kp=[0.05,0.05,3], kd=[0.2,0.2,0.0],ki=[0.000,0.000,0.0]):
        ...
        self.curr_ori=[1500,1500,1500,900]
        self.equilibrium_pose = [self.talker.EQUIILIBRIUM_ROLL, self.talker.EQUIILIBRIUM_PITCH, self.talker.EQUIILIBRIUM_YAW, 900]#need to do something about thrust
    ...
    def pos_change(self,targ_pos=([0,0,0]),curr_pos = ([0,0,0]), curr_ori = ([1500, 1500, 1500, 900])):# Corrects only position
        # if not self.breaker:
